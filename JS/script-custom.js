    ...
    switch (this.id) {
        case "studentId":
            validateAndUpdateFeedback(
                ...
                validateStudentId,
                "Hợp lệ",
                "Mã học viên xx-yyyyyyyy trong đó xx là số cuối của năm sinh, yyyyyyyy là các chữ số từ 0-9 vui lòng kiểm tra lại!"
            );
            break;
        case "fullName":
            validateAndUpdateFeedback(
                ...
                validateFullName,
                "Hợp lệ",
                "Họ tên tối thiểu 2 từ và Hoa đầu từ Vui lòng kiểm tra lại."
            );
            break;
        case "email":
            validateAndUpdateFeedback(
